...
class ScreenWidget : public QWidget
{
    Q_OBJECT
public:
    static ScreenWidget* Instance();   //2. 提供情态方法
    explicit ScreenWidget(QWidget* parent = 0);

private:
    static QScopedPointer<ScreenWidget> self;   // 1. 提供静态指针 //QScopedPointer智能指针
    QMenu* menu;            //右键菜单对象
    Screen* screen;         //截屏对象
...
signals:
    void screenshotPixmap(const QPixmap& pix);
};
