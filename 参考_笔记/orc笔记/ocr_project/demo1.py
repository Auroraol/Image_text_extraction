...
def demo1():
    # 测试图片路径
    TestImagePath = f"{os.path.dirname(os.path.abspath(__file__))}\\test2.png"

    # 初始化识别器对象，传入 PaddleOCR-json.exe 的路径。请改成你自己的路径
    ocr = GetOcrApi(r"C:\Users\16658\Desktop\PaddleOCR-json_v.1.3.0\PaddleOCR-json.exe")
    ...
    print(f'\n示例3-字节流识别结果：')
    ocr.printResult(res)  #格式化输出OCR结果
